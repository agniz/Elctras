      ...
      <jsp:include page = "cart.jsp"/>
        ...
        <section class="filters container">
            ...
            <select name="category" id="categoryFilter">
                ...
                <option value="<%out.print(cat.getCategoryId()); %>"><%out.print(cat.getCategoryName());%></option>
                <%} %>
...
<script>
    ...
    const products = document.querySelectorAll('.shopSingleProduct');
    categoryFilterElement.addEventListener('change',()=>{
    	const categoryId = categoryFilterElement.value;
    	console.log(typeof categoryId)
    	products.forEach((product)=>{
    		const productCategoryId = product.dataset.catid;
    		if(categoryId === "-1"){
