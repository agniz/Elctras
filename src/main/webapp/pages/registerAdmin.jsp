    ...
    <section class="registerPage">
        <article class="registerFormContainer">
            <h1>Register Admin</h1>
              <form action="${pageContext.request.contextPath}<%= StringUtils.REGISTER_ADMIN_SERVLET %>" method="post" class="registerForm">
...
<script>
    ...
    // to show sucess and error message
        ...
        if(status == "success"){
        	swal("Created", "Admin account Created sucessfully, Please proceed to login page","success")
